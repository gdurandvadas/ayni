<!-- Generated by `cargo doc-cli`; do not edit directly. -->

> **Generated reference.** Change the CLI definition, then run `cargo doc-cli > docs/cli.md`; do not edit this file directly.
...
**Usage:** `ayni env storage [OPTIONS]`

###### **Options:**

* `--repo-root <REPO_ROOT>` — Repository root whose current lock and materialized state are inspected
...
* `--apply` — Remove selected candidates; without this flag the command is read-only
