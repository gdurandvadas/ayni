...
pub struct PythonImpactCapability;

impl ImpactCapability for PythonImpactCapability {
    ...
    fn analyze(&self, request: &ImpactRequest) -> Result<ImpactContribution, AdapterError> {
        ...
        if relevant {
            contribution.uncertainties.push(ImpactUncertainty {
                ...
                detail: String::from(
                    "uv Python package topology is not yet mapped; checks broaden to configured root",
                ),
            });
                ...
                contribution.selected_checks.push(SelectedCheck::root(
                    ...
                    *signal,
                    ImpactReason {
                        ...
                        detail:
                            "python impact capability conservatively uses configured-root execution"
                                .into(),
                    },
    ...
    fn relevant_change_is_deterministic_and_records_missing_topology() {
        ...
        let request = ImpactRequest::new(
            ...
            vec![ChangedPath {
                ...
                path: String::from("requirements.txt"),
                previous_path: None,
            }],
            [SignalKind::Test],
        )
